        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-primary/5 pb-12">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-secondary">Heritage Registry</p>
            </div>
            <h1 className="text-5xl lg:text-6xl font-serif text-primary tracking-tighter leading-none">Collector Registry</h1>
            <p className="text-lg text-primary/40 font-medium max-w-xl">
              Mapping the lineage of our masterpieces. Understanding the patrons who breathe life into the RoyalRoot collection.
            </p>
          </div>
